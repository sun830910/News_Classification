...
test_data_file = '/Users/chiang/数据/天池_零基础入门NLP_新闻文本分类/test_a.csv'
...
if __name__ == '__main__':
    ...
    # build word encoder
    word2vec_path = './Embedding/word2vec.txt'
    dropout = 0.15
    ...
    save_model = './Model/rnn.bin'
    save_test = './Model/rnn.csv'
